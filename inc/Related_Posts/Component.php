...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_enqueue_related_posts_script() {
		...
		if ( is_single() ) {
			...
			wp_script_add_data( 'wp-rig-related-posts', 'defer', true ); // Adds metasata to script - in this case the defer=true attribute.
			// We will be able to use the postdata variable in related.js.
			wp_localize_script(
				'wp-rig-related-posts',
				'postdata',
				array(
